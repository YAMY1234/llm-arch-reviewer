...
from models.qwen38_flash_next.build.build_qwen38_flash_next_cudagraph_profile import (  # noqa: E402
    decode_steps,
...
class Qwen38FlashNextCudaGraphProfileTest(unittest.TestCase):
