#!/usr/bin/env python3
"""Map one Qwen 4.0 eager Torch trace onto stable IR nodes."""
...
from models.qwen40.build.qwen40_trace_rules import make_qwen40_trace_rules
...
def main() -> int:
    ...
    result = build_trace_mapping(
        ...
        rank=args.rank,
        phase=args.phase,
        rules=make_qwen40_trace_rules(args.config_name),
