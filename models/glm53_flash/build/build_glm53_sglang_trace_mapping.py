#!/usr/bin/env python3
"""Map one GLM-5.3-Flash SGLang eager trace onto stable IR nodes."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--source-commit", default="033446bb05f35c0943aed2750c443077ffc0b92c"
    )
...
def main() -> int:
    ...
    result = build_trace_mapping(
        ...
        rank=args.rank,
        phase=args.phase,
        rules=GLM53_SGLANG_TRACE_RULES,
        n_iters=args.n_iters,
        skip_first=False,
        expected_phase_frame=(
            "_execute_extend" if args.phase == "forward_extend" else "_execute_decode"
        ),
    )
