#!/usr/bin/env python3
"""Build Qwen3.8-Flash-Next EAGLE-MTP profiles from eager semantics and measured timing."""
...
from models.qwen38_flash_next.build.build_qwen38_flash_next_eager_prefill_profile import (  # noqa: E402
...
def build(args: argparse.Namespace) -> tuple[dict[str, Any], dict[str, Any], dict[str, Any]]:
    ...
    profile_id = (
        "qwen38_flash_next_tp4_mtp_eager_prefill_gbs1_8k"
