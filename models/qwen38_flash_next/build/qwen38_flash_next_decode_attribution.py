#!/usr/bin/env python3
"""Deterministic Qwen3.8-Flash-Next CUDA-Graph decode attribution.
...
def direct_kernel_mapping(name: str) -> tuple[str | None, str | None]:
    ...
    rules = (
        (
            ...
            "ple.ngram_hash",
            "fused Qwen3.8-Flash-Next PLE N-gram hash",
        ),
        (
            "_qwen4_gate_value_kernel",
            "ple.grouped_norm_gate",
            "fused Qwen3.8-Flash-Next PLE post-reduction gate + value broadcast",
        ),
        (
            "_qwen4_short_conv_state_kernel",
            "ple.short_conv",
            "fused Qwen3.8-Flash-Next PLE short-conv state movement",
        ),
